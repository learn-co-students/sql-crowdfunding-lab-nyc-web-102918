-- #DISCLAIMER: Inputs were taken from the lab solution (seemed like a bit of a waste to come up with all this info just to demonstrate the concept of inserting values into a table)
